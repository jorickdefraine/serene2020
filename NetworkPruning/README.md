# EIDOSearch/NetworkPruning

Implementation of a pruning procedure using [EIDOSearch](https://github.com/EIDOSlab/EIDOS-Research) modules.

## Requirements
* PyTorch >= 1.2.0
* CUDA >= 9.2
* Tensorboard
* [EIDOSearch](https://github.com/EIDOSlab/EIDOS-Research#installation)
...
optional arguments:
  ...
  -model {lenet300,lenet5,alexnet,resnet32,resnet18,resnet50,resnet101}
  ...
  -sensitivity {lobster,neuron-lobster,serene}
  ...
  -serene_alpha SERENE_ALPHA
                        For SERENE regularization only. Alpha value.
  -lr_cycling           ULearning rate cycling. Default = False.
